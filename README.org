...
* Illustration
#+html: <p align="center"><img src="timu-spacegrey-1.png" width="100%"/></p>

#+html: <p align="center"><img src="timu-spacegrey-2.png" width="100%"/></p>
...
* Configuration
There is a light version now included as well. By default the theme is `dark'.
To setup the `light' flavour add the following to your `~/.emacs.d/init.el' or `~/.emacs':
